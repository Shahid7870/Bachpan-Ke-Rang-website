      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xs sm:text-sm text-slate-600 mt-1">
            Save or scan to connect directly with Bachpan Ke Rang in Laukaha, Bihar.
          </p>
        </div>

        <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-xl border border-amber-200 max-w-3xl mx-auto">
          <div className="w-full flex justify-center items-center overflow-hidden rounded-xl border border-slate-100">
            <img
              src="/assets/VistingCard.jpeg"
              alt="Bachpan Ke Rang Visiting Card - Md Saquib Raza, Laukaha Bihar"
